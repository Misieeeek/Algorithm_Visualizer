...
//============================CYCLE SORT=======================================
TEST_F(Visualization_Test, cycle_sort_sorts_corretcly) {
  std::vector<int> test_values = {5, 3, 8, 6, 2};
  visualization.test_set_elements(test_values);
  visualization.cycle_sort();
  std::sort(test_values.begin(), test_values.end());
  EXPECT_EQ(visualization.test_get_elements(), test_values);
}

TEST_F(Visualization_Test, cycle_sort_handles_empty_array) {
  std::vector<int> test_values{};
  visualization.test_set_elements(test_values);
  visualization.cycle_sort();
  std::sort(test_values.begin(), test_values.end());
...
TEST_F(Visualization_Test, cycle_sort_handles_single_element) {
  std::vector<int> test_values = {42};
  visualization.test_set_elements(test_values);
  visualization.cycle_sort();
  std::sort(test_values.begin(), test_values.end());
...
TEST_F(Visualization_Test, cycle_sort_handles_already_sorted_array) {
  std::vector<int> test_values = {1, 2, 3, 4, 5};
  visualization.test_set_elements(test_values);
  visualization.cycle_sort();
  std::sort(test_values.begin(), test_values.end());
...
TEST_F(Visualization_Test, cycle_sort_handles_reverse_sorted_array) {
  std::vector<int> test_values = {5, 4, 3, 2, 1};
  visualization.test_set_elements(test_values);
  visualization.cycle_sort();
  std::sort(test_values.begin(), test_values.end());
...
TEST_F(Visualization_Test, cycle_sort_handles_negative_values) {
  std::vector<int> test_values = {-5, -3, -8, -6, -2};
  visualization.test_set_elements(test_values);
  visualization.cycle_sort();
  std::sort(test_values.begin(), test_values.end());
...
TEST_F(Visualization_Test, cycle_sort_handles_mixed_values) {
  std::vector<int> test_values = {-5, -3, 8, -6, 2};
  visualization.test_set_elements(test_values);
  visualization.cycle_sort();
  std::sort(test_values.begin(), test_values.end());
...
//============================WEAK HEAP SORT=======================================
TEST_F(Visualization_Test, weak_heap_sort_sorts_corretcly) {
  std::vector<int> test_values = {5, 3, 8, 6, 2};
  visualization.test_set_elements(test_values);
  visualization.weak_heap_sort();
  std::sort(test_values.begin(), test_values.end());
  EXPECT_EQ(visualization.test_get_elements(), test_values);
}

TEST_F(Visualization_Test, weak_heap_sort_handles_empty_array) {
  std::vector<int> test_values{};
  visualization.test_set_elements(test_values);
  visualization.weak_heap_sort();
  std::sort(test_values.begin(), test_values.end());
...
TEST_F(Visualization_Test, weak_heap_sort_handles_single_element) {
  std::vector<int> test_values = {42};
  visualization.test_set_elements(test_values);
  visualization.weak_heap_sort();
  std::sort(test_values.begin(), test_values.end());
...
TEST_F(Visualization_Test, weak_heap_sort_handles_already_sorted_array) {
  std::vector<int> test_values = {1, 2, 3, 4, 5};
  visualization.test_set_elements(test_values);
  visualization.weak_heap_sort();
  std::sort(test_values.begin(), test_values.end());
...
TEST_F(Visualization_Test, weak_heap_sort_handles_reverse_sorted_array) {
  std::vector<int> test_values = {5, 4, 3, 2, 1};
  visualization.test_set_elements(test_values);
  visualization.weak_heap_sort();
  std::sort(test_values.begin(), test_values.end());
...
TEST_F(Visualization_Test, weak_heap_sort_handles_negative_values) {
  std::vector<int> test_values = {-5, -3, -8, -6, -2};
  visualization.test_set_elements(test_values);
  visualization.weak_heap_sort();
  std::sort(test_values.begin(), test_values.end());
...
TEST_F(Visualization_Test, weak_heap_sort_handles_mixed_values) {
  std::vector<int> test_values = {-5, -3, 8, -6, 2};
  visualization.test_set_elements(test_values);
  visualization.weak_heap_sort();
  std::sort(test_values.begin(), test_values.end());
